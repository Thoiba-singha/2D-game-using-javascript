class Game {
    ...
    resize(width, height){
        ...
        this.ctx.font = this.smallFont + 'px sans-serif';
    ...
    checkCollision(a,b){
        ...
        const distance = Math.hypot(dx, dy); // another way is pithagurous theorem (dx*dx+dy*dy)
    ...
    triggerGameOver(){
        if(!this.gameOver){
            ...
            if(this.obstacles.length <= 0){
                ...
                this.message2 = "Your time " + this.formatTimer() + 'seconds!';
            }
        }
    }
    drawStatusText(){
        ...
        if(this.gameOver){
            ...
            this.ctx.font = this.largeFont + 'px sans-serif';
